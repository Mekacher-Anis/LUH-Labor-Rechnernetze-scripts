...
command=$(cat <<-EOF
sudo tc qdisc add dev $3 root handle 1:0 prio priomap 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 &&
sudo tc qdisc add dev $3 parent 1:1 handle 2:0 sfq &&
sudo tc qdisc add dev $3 parent 1:2 handle 3:0 htb default 1 &&
sudo tc class add dev $3 parent 3:0 classid 3:1 htb rate 50mbit &&
sudo tc filter add dev $3 parent 1:0 prio 1 protocol ip u32 match ip dport 30001 0xffff flowid 1:1 &&
sudo tc filter add dev $3 parent 1:0 prio 2 protocol ip u32 match ip src 10.0.0.3/32 flowid 1:2 &&
sudo tc filter add dev $3 parent 1:0 prio 3 protocol all u32 match u32 0 0 flowid 1:3
EOF
)

sudo tc qdisc add dev enp101s0f0 root handle 1:0 prio priomap 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 &&
sudo tc qdisc add dev enp101s0f0 parent 1:1 handle 2:0 sfq &&
sudo tc qdisc add dev enp101s0f0 parent 1:2 handle 3:0 htb default 1 &&
sudo tc class add dev enp101s0f0 parent 3:0 classid 3:1 htb rate 50mbit &&
sudo tc filter add dev enp101s0f0 parent 1:0 prio 1 protocol ip u32 match ip dport 30001 0xffff flowid 1:1 &&
sudo tc filter add dev enp101s0f0 parent 1:0 prio 2 protocol ip u32 match ip src 10.0.0.3/32 flowid 1:2 &&
sudo tc filter add dev enp101s0f0 parent 1:0 prio 3 protocol all u32 match u32 0 0 flowid 1:3
...
sshpass -p $2 ssh -f -o StrictHostKeyChecking=no -o ConnectTimeout=5 -o ConnectionAttempts=3 $1@receiver1 "iperf -s -y C -i 1 -P 1 -u -p 5001 > /tmp/tc_configuration_experiment1_10s.csv &"
  
sshpass -p $2 ssh -f -o StrictHostKeyChecking=no -o ConnectTimeout=5 -o ConnectionAttempts=3 $1@sender1 "iperf -c receiver1 -p 5001 -P 1 -u -b 1000mbit -t 60 &"

echo "Starting inter 1"

sleep 40

sshpass -p $2 ssh -f -o StrictHostKeyChecking=no -o ConnectTimeout=5 -o ConnectionAttempts=3 $1@receiver2 "iperf -s -y C -i 1 -P 1 -u -p 30001 > /tmp/tc_configuration_experiment1_30s.csv &"
  
sshpass -p $2 ssh -f -o StrictHostKeyChecking=no -o ConnectTimeout=5 -o ConnectionAttempts=3 $1@sender2 "iperf -c receiver2 -p 30001 -P 1 -u -b 1000mbit -t 60 &"
